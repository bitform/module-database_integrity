...
function dbi_get_compatible_modules()
{
  ...
  foreach ($module_list as $module_info)
  {
    ...
    if (!dbi_check_has_table_verification($module_folder))
      continue;
 ...
 * file, contains the table structure verification information.
 *
 * @param string $module_folder
 * @return boolean
 */
function dbi_check_has_table_verification($module_folder)
{
  global $g_root_dir;
  require("$g_root_dir/modules/$module_folder/database_integrity.php");
  return isset($STRUCTURE);
}
